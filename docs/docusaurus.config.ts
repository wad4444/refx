...
const config: Config = {
  ...
  organizationName: 'wad4444', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    footer: {
      style: 'dark',
      copyright: `Copyright © ${new Date().getFullYear()} refx, Inc. Built with Docusaurus.`,
    },
    prism: {
